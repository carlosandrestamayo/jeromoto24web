<template>
    <div class="q-pa-xs">    
        ...
        <q-card class="q-pb-md q-pr-md" v-if="!orden.modalMoto" style="margin-top:1%">
            ...
            <q-card class="q-ma-md">
                <div class="row">
                    <q-input color="black" mask="######" stack-label autofocus v-model="orden.dato.km" label="*Kilometraje"   class="col-2 q-px-md" v-if="orden.datoMoto.id > 0" />
            ...
            <div class="row q-px-lg" style="" v-if="orden.datoMoto.id != 0">   
                ...
                <q-expansion-item expand-separator icon="" v-model="ex" class="col-6 q-pl-md" label="   Solicitudes">
                    <q-card>
                        <q-input v-model="orden.s1" counter maxlength="60" outlined  stack-label label="Solicitud 1" color="black" class="q-mb-xs" />
                        <q-input v-model="orden.s2" counter maxlength="60" outlined stack-label label="Solicitud 2" color="black" class="q-mb-xs"/>
                        <q-input v-model="orden.s3" counter maxlength="60" outlined stack-label label="Solicitud 3" color="black" class="q-mb-xs" />
                        <q-input v-model="orden.s4" counter maxlength="60" outlined stack-label label="Solicitud 4" color="black" class="q-mb-xs" />
                        <q-input v-model="orden.s5" counter maxlength="60" outlined stack-label label="Solicitud 5" color="black" />
                    </q-card>
                </q-expansion-item>
