<template>
    <div class="q-pa-md">
        ...
        <q-table v-if="tipo.accion.value == -1 && !tipo.modalTabla" flat bordered title="Referencias" :rows="tipo.rows" :columns="tipo.columns"
            row-key="name" :filter="tipo.filter" style="" class="tabla" :rows-per-page-options="rppo">
        ...
        <q-card class="my-card q-pb-md" style=""
        ...
        <q-card class="my-card q-pb-md" style="width:60%;margin-left:20%;margin-top:1%" v-if="tipo.modalTabla && !tipo.modalEditTabla">
            ...
            <q-table flat bordered   :rows="tipo.optionsTabla" :columns="tipo.columnsTabla"
                ...
                <template v-slot:body="props">
                    ...
                    <q-tr :props="props">
                        ...
                        <q-td auto-width>
                            <q-btn size="md" color="negative" round dense @click="tipo.openModalEditTabla(props.row.id)" icon="edit" />
                        </q-td>
                    </q-tr>
         ...
         <q-card class="my-card q-pb-md" style="" v-if="tipo.modalEditTabla">
