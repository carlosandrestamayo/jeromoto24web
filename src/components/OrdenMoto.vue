    ...
    <q-card class="q-pb-md" style="margin-top:4%">
                 ...
                 class="my-sticky-header-table"
                    ...
                    <!--<template v-slot:top>
                        <div class="q-table__control">
                            <div class="q-table__title">ORFE</div>
                        </div>
                        <div class="q-table__separator col"></div>
                        <div class="q-table__control">
                        <q-btn color="dark" class="q-mt-md" size="md" icon="print" round dense @click="moto.imprimirOrden"/>
                    </div>
                    </template>-->

                     <template v-slot:top>
                        <div class="q-table__control q-mr-lg">
                            <div class="q-table__title">Ordenes de Servicio</div>
                        </div>

                        <!--<q-btn color="dark" class="q-mt-md" size="md" icon="print" round dense @click="moto.imprimirOrdenesMoto"/>-->
                        <q-space />
                        <q-input style="width:400px;" color="black" autofocus dense debounce="300" v-model="ov.filter" placeholder="Search">
                            <template v-slot:append>
                                <q-icon :name="ov.filter == '' ? 'search' : 'close'" @click="ov.filter = ''" class="cursor-pointer" />
        ...
        <div class="row " style="" v-if="ov.selectOrden.length > 0">
            ...
            <q-card-actions align="right" class="q-pr-md">
                <q-btn color="primary"  @click="moto.closeModalViewOrdenes" style="width:90px">Ok
                </q-btn>
            </q-card-actions>
...
<script >
    ...
    export default defineComponent({
        ...
        beforeMount() {
            ov.init({params:{opcion:22,motoId:moto.dato.id}});
        },
        methods:{
