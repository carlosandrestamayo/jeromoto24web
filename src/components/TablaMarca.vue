<template>
    <div class="q-pa-md" id="tablamarcaId">
        
        <q-table v-if="marca.accion.value == -1" flat bordered title="Marcas" :rows="marca.rows" 
        :columns="marca.columns" row-key="name" :filter="marca.filter" style="" class="tabla" 
                :rows-per-page-options="rppo">
        ...
        <q-dialog v-model="marca.notificacion.type" >
            <q-card class="text-black" style="width:500px;">
